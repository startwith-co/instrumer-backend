...
import instrumers.backend.solution.repository.SolutionImageRepository;
import instrumers.backend.solution.domain.SolutionKeywordEntity;
import instrumers.backend.solution.repository.SolutionKeywordRepository;
import instrumers.backend.solution.domain.SolutionPlanDetailEntity;
import instrumers.backend.solution.repository.SolutionPlanDetailRepository;
import instrumers.backend.solution.domain.SolutionPlanEntity;
import instrumers.backend.solution.repository.SolutionPlanRepository;
